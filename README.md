...
- **Unified workspace navigation**: consistent content width with an always-visible native chat search, a native primary wide New chat action rendered directly below the always-visible native chat search, with a standard comfortable touch target and reduced horizontal sidebar padding, a clean native three-dot rename/delete menu, and Markdown export
