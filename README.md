...
- **Unified workspace navigation**: consistent content width with an always-visible native chat search, a transparent native wide New chat action with matching sidebar background, pinned above the scrolling chat list, clear rename/delete actions, and Markdown export
