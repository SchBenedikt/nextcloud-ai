...
class EvaContextWriteProvider implements ISynchronousProvider {
	...
	public function process(?string $userId, array $input, callable $reportProgress): array {
		...
		$systemPrompt = 'You are an experienced writer who writes in various styles. '
			. 'Write a text based on the following instructions. '
			. 'Answer in the same language as the instructions. '
			. 'Return only the written text, with no additional explanation.';
