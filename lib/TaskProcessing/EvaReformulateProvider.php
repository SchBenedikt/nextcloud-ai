	...
	public function process(?string $userId, array $input, callable $reportProgress): array {
		...
		$messages = [
			['role' => 'system', 'content' => 'You are a helpful assistant that reformulates text. '
				. 'Rewrite the text so that it becomes clearer, more understandable or more elegant. '
				. 'Keep the original meaning and intent. '
				. 'Answer in the same language as the original text. '
				. 'Return only the reformulated text, with no additional explanation.'],
			['role' => 'user', 'content' => 'Reformulate the following text:\n\n' . $prompt],
		];
