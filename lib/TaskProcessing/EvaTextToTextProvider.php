...
class EvaTextToTextProvider implements ISynchronousProvider {
	...
	public function process(?string $userId, array $input, callable $reportProgress): array {
		...
		$messages = [
			['role' => 'system', 'content' => 'You are a helpful, precise assistant. Always answer in the language of the user question.'],
