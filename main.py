...
# This function handles the /v1/models endpoint and returns the list of models.
@app.route('/v1/models', methods=['GET'])
def get_models():
    return jsonify(models)

# This function catches all other routes and forwards the request to the Cloudflare API.
