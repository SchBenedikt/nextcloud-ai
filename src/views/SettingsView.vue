			...
			<section class="settings-section">
				...
				<label class="action-toggle">
					<input
						...
						true-value="1"
						false-value="0" />
					<span>Allow AI to create and manage files on my Nextcloud</span>
				</label>
				<p class="field-hint">
				...
				<p class="field-hint">
					<strong>Allowed file types</strong>: comma-separated extensions the AI may create/overwrite, e.g. <code>md,txt,csv</code>.
					Empty means any plain-text file. <strong>Max. characters per file</strong>: size guard for AI-written files.
				</p>
				...
				<fieldset class="perm-group">
					...
					<label class="action-toggle">
						...
						<span>Off — the AI may never delete files</span>
					</label>
					<label class="action-toggle">
						<input type="radio" v-model="f.exec_delete_mode" value="own" />
						<span>Only files the AI created itself</span>
					</label>
					<label class="action-toggle">
				...
				<label class="action-toggle notify-toggle">
					<input
						...
						true-value="1"
						false-value="0" />
					<span>Show a Nextcloud notification when an AI answer is finished</span>
				</label>
			</section>
	...
	setup() {
		...
		async function loadStatus() {
			try {
				...
				console.error('[ragchat] settings status error', e)
			}
		}
