 ...
 * MultimodalContextAgentProvider
 */
class TaskProcessingContractTest extends TestCase {
    ...
    private function providerClasses(): array {
        return [
            ...
            \OCA\EvaAi\TaskProcessing\EvaAnalyzeImagesProvider::class,
            \OCA\EvaAi\TaskProcessing\EvaTextToImageProvider::class,
            \OCA\EvaAi\TaskProcessing\EvaAudioToTextProvider::class,
            ...
            \OCA\EvaAi\TaskProcessing\MultimodalContextAgentProvider::class,
        ];
    }
    ...
    public function testTaskTypeIdsAreValid(): void {
        $validTypes = [
            ...
            'core:contextagent:multimodal-interaction',
        ];
